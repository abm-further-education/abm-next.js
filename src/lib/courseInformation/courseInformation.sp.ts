...
export const courseInformationData_sp: {
  ...
  'industry-placement-work-placement': {
    ...
    tables: [
      ...
      // },
      {
        headers: ['Trimestre', '', 'Horas de prácticas en la industria'],
        rows: [
          ['Trimestre 1', 'Teoría + Clase práctica', 'N/A'],
          ['Trimestre 2', 'Teoría + Clase práctica', 'N/A'],
          [
            'Trimestre 3',
            'Teoría + Clase práctica',
            '16 horas adicionales por semana',
          ],
          [
            'Trimestre 4',
            'Teoría + Clase práctica',
          ...
          ['Trimestre 6', '-', '20 horas por semana'],
          ['Total', 'Teoría + Clase práctica', '600 horas'],
        ],
      },
    ],
    partners: [
