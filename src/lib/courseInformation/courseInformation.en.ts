...
export const courseInformationData: { [key: string]: CourseInformationInfo } = {
  ...
  'industry-placement-work-placement': {
    ...
    description:
      'Are you ready to take your cookery skills to the next level?\n\nAt ABM Further Education, we recognise that real industry experience is just as important as theoretical and practical learning in the kitchen.\n\nThe Certificate IV in Kitchen Management prepares students for supervisory and leadership roles in commercial kitchens by combining classroom learning with extensive practical experience. Students will have the opportunity to train in real hospitality environments such as restaurants, hotels, and aged care facilities, guided by experienced industry professionals.\n\nTo strengthen employability and ensure career readiness, the course now includes 600 hours of structured industry placement, commencing from Term 3.\n\nFrom Term 3, students can complete up to 16 additional hours per week, and from Term 6, up to 20 additional hours per week as part of their industry placement. This enhanced structure allows students to apply their classroom learning in real workplaces, developing essential skills, confidence, and a deeper understanding of kitchen operations.\n\nThese industry placement hours are a mandatory component of the qualification and form an integral part of ABM’s commitment to providing practical, career-focused education.',
    deliveryMode: {
      title: 'Delivery mode',
      ...
      },
      {
        ...
        rows: [
          [
            ...
            'Term 1',
            'Week 1 – 10: Theory class + Practical Class',
            'Nil',
          ],
          [
            'Diploma of Hospitality Management',
          ...
          [
            'Diploma of Hospitality Management',
            'Term 5',
            'Week 1 – 10: 1 day per week Face to Face class + 3 days per week Work Placement (5 hours x 3 shifts)',
            'SITHIND008 Work effectively in hospitality service\n• Week 1 – 10 = 150 hours',
          ],
          [
            'Diploma of Hospitality Management',
            'Term 6',
            'Week 1 – 9: 1 day per week Face to Face class + 3 days per week Work Placement (5 hours x 3 shifts)\nWeek 10: Theory + Practical Class',
            'SITHIND008 Work effectively in hospitality service\n• Week 1 – 9 = 135 hours',
          ],
          [
            'Total',
            '',
            '60 weeks teaching period + 18 weeks Term break (Total: 78 weeks)',
            '',
          ],
          [
          ...
          [
            'Total',
            '',
            '20 weeks teaching period + 6 weeks Term break (Total: 26 weeks)',
            'Total – 0 hours',
          ],
        ],
      },
