...
export const courseInformationData_jp: {
  ...
  'certificate-iii-in-fitness-online': {
    courseCode: 'SIS30321',
    description:
      'フィットネスインストラクターとしてのキャリアをスタートさせよう！\n\nSIS30321 Certificate III in Fitness（オンライン）は、グループ運動インストラクターまたはジムインストラクターを目指す方を対象とします。本資格では、グループ運動セッションの計画・実施、およびジムベースのプログラムを設計する能力を身につけます。ただし、個別指導や持続的なクライアントモニタリングには制限があります。\n\n受講者はフィットネスセンター、ジム、地域レクリエーション施設など、構造化された監督環境で働きます。運動セッションの実施やクライアント対応においては、組織の方針・手順に従い判断力を用います。\n\nこの資格は以下の就業分野への直接的な進路を提供します：\n– フィットネスセンター & ジム\n– レジャー & コミュニティ施設\n– 健康 & ウェルネスクラブ',
      ...
      locations: [
        {
          type: '完全オンライン',
          address:
            '理論・課題はオンラインで実施。実技トレーニングと評価は指定の施設で手配に応じて実施します。',
        },
      ],
    },
    startingDates: [
  ...
  'certificate-iv-in-fitness-online': {
    courseCode: 'SIS40221',
    description:
      'フィットネスインストラクターとしてのキャリアをスタートさせよう！\n\nSIS40221 Certificate IV in Fitness（オンライン）は、パーソナルトレーナーおよび上級フィットネスインストラクターを目指す方を対象とします。本資格では、グループ運動セッションの指導および個別プログラムの設計能力を身につけます。ただし、個別指導や持続的なクライアントモニタリングには制限があります。\n\n受講者はフィットネスセンター、ジム、地域施設など、構造化された監督環境で働きます。運動指導やクライアントとのやり取りにおいては、組織の方針・手順に従い判断力を用います。\n\nこの資格は以下の就業分野への直接的な進路を提供します：\n– フィットネスセンター & ジム\n– レジャー & コミュニティ施設\n– 健康 & ウェルネスクラブ',
    duration: '12週間または24週間',
    entryRequirement: [
      '以下のユニットを修了している必要があります：',
      '• HLTAID011 Provide First Aid（またはこのユニットを置き換えるユニット）',
