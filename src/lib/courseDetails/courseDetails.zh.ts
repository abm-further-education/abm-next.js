...
export const courseDetailsData: { [key: string]: CourseDetailInfo } = {
  ...
  'hlt33115-certificate-iii-in-health-services-assistance': {
    ...
    faq: {
      title: '常见问题',
      description: [
        { question: '护理助理课程的费用是多少？', answer: '请参阅我们的官方价格表以获取最新的学费信息。' },
        { question: '哪种签证可以注册？', answer: '本课程适合持打工度假签证或任何允许在不使用入学确认书（CoE）的情况下学习16周的签证类型的学生。我们不提供签证建议。如有疑问，请检查您的签证条件或咨询注册移民代理。' },
        { question: '临床培训和实习的支持如何？', answer: 'ABM通过我们可信赖的行业合作伙伴提供80小时的实习作为课程的一部分。完成后，我们还为符合条件的毕业生提供带薪就业机会，支持您顺利过渡到医疗保健行业。' },
        { question: '我可以凭此资格找到工作吗？', answer: '是的，我们的毕业生通常在私立医院、医疗中心和老年护理中心找到工作。' },
        { question: '如果我的英语能力不足怎么办？', answer: '最低入学要求是雅思5.5或同等水平。如果您目前持有雅思4.5或同等水平，可以通过Plus Nursing English注册课程，该课程提供针对医疗保健环境的额外语言支持。如果您没有英语考试成绩，可以通过ABM英语分班测试评估您的英语水平。' },
      ],
    },
  },
};
