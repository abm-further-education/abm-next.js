...
export const courseDetailsData_jp: { [key: string]: CourseDetailInfo } = {
  ...
  'hlt33115-certificate-iii-in-health-services-assistance': {
    ...
    faq: {
      title: 'よくある質問',
      description: [
        { question: '看護アシスタントコースの費用はいくらですか？', answer: '最新の学費については、公式料金表をご参照ください。' },
        { question: 'どのビザで登録できますか？', answer: 'このコースは、ワーキングホリデービザまたは入学確認書（CoE）なしで16週間の学習が許可されるビザを所持する学生に適しています。ビザに関するアドバイスは提供しておりません。不明な場合は、ビザ条件を確認するか、登録済みの移住エージェントにご相談ください。' },
        { question: '臨床実習の配置とサポートはどうなっていますか？', answer: 'ABMは、信頼できる業界パートナーを通じて、コースの一環として80時間の実習を手配しています。修了後、資格を満たす卒業生には有給雇用の機会も提供し、医療従事者へのスムーズな移行をサポートします。' },
        { question: 'この資格で就職できますか？', answer: 'はい、卒業生は民間病院、医療センター、高齢者ケア施設などで就職することが多いです。' },
        { question: '英語力が不足している場合はどうすればよいですか？', answer: '最低入学要件はIELTS 5.5または同等です。現在IELTS 4.5または同等をお持ちの場合は、医療現場に特化した追加の言語サポートを提供するPlus Nursing Englishと一緒にコースに登録できます。英語テストの結果がない場合は、ABM英語プレースメントテストで英語力を評価することができます。' },
      ],
    },
  },
};
